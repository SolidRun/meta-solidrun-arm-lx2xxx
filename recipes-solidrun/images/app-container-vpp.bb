...
SUMMARY = "VPP Application container image"
LICENSE = "MIT"
...
OCI_IMAGE_ENTRYPOINT = "vpp"
OCI_IMAGE_TAG = "easy"
OCI_IMAGE_ENTRYPOINT_ARGS = "-c /etc/vpp/startup.conf"
CONTAINER_SHELL = "busybox"

IMAGE_INSTALL:append = "dpdk vpp vpp-plugins"
